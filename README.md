...
- Déploiement en production, montée en charge (Gunicorn, Redis, PgBouncer, réplicas derrière
  nginx) et mesure du débit : voir [backend/DEPLOYMENT.md](backend/DEPLOYMENT.md).
"# monecole" 
