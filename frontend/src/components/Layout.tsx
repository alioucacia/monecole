...
const NAV_CATEGORIES: NavCategory[] = [
  ...
  },
  {
    label: "Général",
    items: [
      { to: "/", label: "Tableau de bord", icon: "🏠", roles: ["admin", "directeur", "teacher", "student", "parent", "comptabilite", "surveillance"] },
    ],
  },
  {
    label: "Pédagogie",
    items: [
      { to: "/eleves", label: "Élèves", icon: "🎓", roles: ["admin", "directeur", "teacher", "comptabilite", "surveillance"] },
      { to: "/reinscription", label: "Réinscription", icon: "🔄", roles: ["admin", "directeur", "comptabilite"] },
      { to: "/enseignants", label: "Enseignants", icon: "🧑‍🏫", roles: ["admin", "directeur", "surveillance"] },
      { to: "/classes", label: "Classes", icon: "🏫", roles: ["admin", "directeur", "teacher", "surveillance"] },
      { to: "/matieres", label: "Matières", icon: "📚", roles: ["admin", "directeur", "surveillance"] },
  ...
  },
  {
    label: "Finance",
    items: [
      { to: "/paiements", label: "Paiements", icon: "💳", roles: ["admin", "directeur", "student", "parent", "comptabilite"] },
      { to: "/caisse", label: "Caisse", icon: "🗃️", roles: ["admin", "directeur", "comptabilite"] },
      { to: "/depenses", label: "Dépenses", icon: "🧮", roles: ["admin", "directeur", "comptabilite"] },
    ],
  },
  {
    label: "Services",
    items: [
      { to: "/bibliotheque", label: "Bibliothèque", icon: "📖", roles: ["admin", "directeur", "teacher", "student", "parent"], feature: "bibliotheque" },
      { to: "/transport", label: "Transport", icon: "🚌", roles: ["admin", "directeur", "student", "parent", "comptabilite"], feature: "transport" },
      { to: "/cantine", label: "Cantine", icon: "🍽️", roles: ["admin", "directeur", "student", "parent", "comptabilite"], feature: "cantine" },
    ],
  },
  {
    label: "Communication",
    items: [
      ...
      { to: "/support", label: "Support technique", icon: "🆘", roles: ["superadmin", "admin", "directeur", "teacher", "student", "parent", "comptabilite", "surveillance"] },
    ],
  },
  {
...
const TOPBAR_ROLE_BADGE: Record<Role, string> = {
  ...
  directeur: "bg-fuchsia-100 text-fuchsia-700",
