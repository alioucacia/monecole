...
const NAV_CATEGORIES: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/reinscription", label: "Réinscription", icon: "🔄", roles: ["admin", "directeur"] },
      { to: "/enseignants", label: "Enseignants", icon: "🧑‍🏫", roles: ["admin", "directeur"] },
      { to: "/classes", label: "Classes", icon: "🏫", roles: ["admin", "directeur", "teacher"] },
      { to: "/matieres", label: "Matières", icon: "📚", roles: ["admin", "directeur"] },
